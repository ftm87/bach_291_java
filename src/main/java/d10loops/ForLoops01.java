...
*/
    ...
    //--------------------------------------------------------
        ...
        // ornek 2; 20 (dahil ) den 3 (dahil) e kadar olan tum tamsayilari yazdirin
        ...
        for (int i = 3; i <21 ; i++) {
          ...
          if (i%2==0) {             // burda cift sayilari istedigimiz icin kontrol icin if  kullanmaliyiz
              System.out.println(i);
          }
        ...
        // 2. yol hic if kullanmadan nasil yapalim.i+=2 ile
