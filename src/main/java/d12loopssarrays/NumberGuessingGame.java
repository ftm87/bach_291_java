...
public class NumberGuessingGame {
    public static void main(String[] args) {
        ...
        Scanner scanner = new Scanner(System.in);// scanner  kullanicidan veri almak icin kuallanilir
        Random random = new Random();// random rastgele bir sayi uretmek icin kullanilir
