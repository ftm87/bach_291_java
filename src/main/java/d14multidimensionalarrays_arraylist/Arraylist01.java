...
public class Arraylist01 {
 ...
 /*
        ...
        */
        ...
        //ArrayList<Integer> ages = new ArraysList<>(); java 6 ve oncesi

        ArrayList<Integer> ages= new ArrayList<>() ;  //Java 7 ve sonrasi -type inference -tip cikarimi,jav artik soldaki data tipini sagda sayiyor
        ...
        //List'te araya eleman eklemek icin index numarasini yazariz
         ...
         ages.add(1,28);// yani burda 1. indexte 28 numarali elemn olmali
        ...
        ages.addAll(newAges);   //ages e ekledik newages elemnalari
     ...
     //get(int index) metodu, ArrayList’te belirli bir konumdaki ogeye erismek icin kullanilir.
        ...
        // Bu metot, listedeki bir öğeyi güncellemek için kullanılır.
        // Metot, eski öğeyi döndürür.


     Integer a   =ages.set(1,12);
        System.out.println(a);// 2, eski deger ,degistirdigi deger
