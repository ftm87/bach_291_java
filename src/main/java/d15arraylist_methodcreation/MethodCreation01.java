...
public class MethodCreation01 {
 ...
 //  javada bir method icnde baska method olmaz. ama clas icinde class olabiir orda method yine acilir ama kendi icinde olur
        ...
        2- Syntax'i: Access Modifier(public) + Return Type + Method ismi + () + {}
        3- Olusturulan method nasil kullanilir?
            Main icinden method cagrisi yapilmalidir. Buna Method Call denir.*/

        int result = sum(3,5);//verileri gonderr ve sonra sonucu icinde tutar
    ...
    //toplama yapan bir method olusturunnuz
