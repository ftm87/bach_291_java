...
//--------------------------------------
    ...
    //1-varieble lar olusturalim (pasif ozellikler)


    String brand = "Honda";//marka
    String model = "Accord";
    int year = 2023;
    boolean hybrid = true;
...
costracter statik olmz
   ...
   !!! Parametreli constructorlar olusturarak ayni classdan farkli özelliklere sahip object'ler olusturabiliriz*/
    ...
    public Car(String brand, String model, int year, boolean hybrid) {
        ...
        this.brand = brand; // bu class daki brand degerini kullanma , ben sana parametre olarak gonderecegim demek bu
        this.model = model;
        this.year = year;
        this.hybrid = hybrid;
    }
    //8-Parametreli constructor’i olusturdugumuza da Java default olani sildi, CarRunner’dakiler o yuzden
