...
public class DateTime02 {
    ...
    //If the date you have received from the user is in the future, say “You can enter the time”.
        ...
        LocalDate givenDate = LocalDate.of(year,mounth,day);// burda spesifik bir tarih yapmak istiyoruz. iki durumu karsilamak cin if else acalim

        if (givenDate.isBefore(LocalDate.now())){  // kullanicini girdigi tarih suandan once ise
