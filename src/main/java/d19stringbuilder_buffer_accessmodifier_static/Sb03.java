...
// Buradaki offset, eklemenin başlayacağı konumu belirtir ve aslında bir index görevi görür.
    ...
    StringBuilder sb2 =new StringBuilder("Zava");   //java                   java
    StringBuilder sb3 =new StringBuilder("Kava");    //kava   sonuc -1 cikar  java   sonuc 0 cikar

   int result=sb2.compareTo(sb3);
        System.out.println(result);//15  k 75 z 90 arasindaki farki alidk
   //-----------------------------------
   ...
   //7-toString() metodu, StringBuilder nesnesinin içeriğini bir String nesnesine dönüştürür.
      ...
      StringBuilder newSb1 =new StringBuilder(str);
        System.out.println(newSb1);//HA34SANSI AVAJ    Data type Stringbuilder oldu
...
farklı görevleri işleyebilir ve böylece işlerin
 daha hızlı ve etkili bir şekilde tamamlanmasına olanak tanır.*/
