...
parçalarını tekrar tekrar yazmaktan kaçınırsınız.
   ...
   oluşturulduğunda, otomobilin rengini ve yakıt türünü belirlemek için instance bloklarını kullanabilirsiniz.
    ...
    {
        System.out.println("Merhaba java kullanicilari"); //  bunu gorebilmek icin obje olusturulmali
    }
    ...
    public static void main(String[] args) {
       ...
       InstanceBlock1 obj2 =new InstanceBlock1();//Merhaba java kullanicilari(her obje icin tektek calisir)
