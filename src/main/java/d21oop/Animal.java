...
public class Animal {
    ...
    */
    ...
    // i.Method Overloading: Bunu gormustuk --bir methodun cok defa kullanilmasidir.icibdeki parametler degisir

    //ii.Method Overriding (gecersiz kilmak ,agir basan )
    // child classin  parentttaki methodu degistirerek kullanmasidir
...
//---------------------
    ...
    public Animal create(){// data tip animal
        return new Animal();
        //Animal classdan bir obje utrettik
