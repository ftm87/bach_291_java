...
public class Queue01 {
    ...
    Queue interface'i, LinkedList ve PriorityQueue gibi farklı class'lar tarafından uygulanabilir.*/
        ...
        String s = storage.remove();// burda bir degisken olusturduk aslinda direk soutlada yazdirabilirdik
        ...
        System.out.println(emergencyQueue);//[Ekrem, Mehmet, Mahmut, Oya, Tansu] siralama karisik
        ...
        d.add("Oya");
        d.add("Tansu");
        System.out.println(d);//[Mehmet, Mahmut, Ekrem, Oya, Tansu] siaralama insert
        ...
        for (String w : d) {
            System.out.println(w);// burda elemamlari alt alta yazdirmak icin kullaniriz
        }
        System.out.println("---------------------------");
