...
public class Map04 {
    public static void main(String[] args) {
        ...
        //Thread Safe, Multi Thread(coklu is parcacigi), Synchronized kavramlarini inceleyelim
...
Thread safety ve performansın önemli olduğu her durumda tercih edilir.*/
       ...
       // studentGrades.put(null,50);HATA
        ...
        stock.putIfAbsent("Cilek",30);// cilek yoksa onuda ekle
        System.out.println(stock);//{Muz=20, Elma=10, Cilek=30}

        stock.replace("Muz",20,25);//eski haline gelirsa guncelle yukselt
 ...
 */
        ...
        System.out.println(countryPopulation);//{Germany=83000000, Italy=null, Netherland=18000000, Turkiye=83000000, USA=400000000}
    ...
    */
        ...
        for (Map.Entry<String,Integer>entry:lhm.entrySet()){
          ...
          //Ali-->25
            //Can-->18
            //Mehmet-->30// bu insertion order(yukleme sirasi)
     ...
     //--------------------------
       ...
       HashMap<String,String>capitalis =new HashMap<>();
        capitalis.put("USA", "Washington");
        capitalis.get("USA");
        capitalis.put("Italy","Rome");
        capitalis.get("Italy");
        capitalis.put("Turkiye","Ankara");
        capitalis.get("Turkiye");
        capitalis.put("Turkiye","Istanbul");
    }
    }
