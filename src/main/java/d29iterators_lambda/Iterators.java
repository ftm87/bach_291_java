...
public class Iterators {
    public static  void main(String[] args) {
      ...
      /*  while (myItr.hasNext()){        // en basa konumlanan pointerden sonra eleman  var mi diye bkar
        ...
        System.out.println(myList);//[]  tum elemanlar silindi*/
        ...
        while (listItr2.hasNext()) { // bu dongu surekli calisir ve pointiri sona goturur
            listItr2.next();
        }
