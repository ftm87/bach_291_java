...
//-----------------------------
    ...
    //   yazdiran method'u olusturunuz.(Functional)lambda ile yap
    ...
    //Akışın (stream) adı, verinin bir kaynaktan hedefe doğru "akmasını" ifade eder.
      ...
      public static void printElements2(List<Integer> nums) {
             nums.
                stream().//bunu yazmasakta calisir
                forEach(t -> System.out.print(t + " "));// t -> akistan gelen her bir t degeri icin 12 9 131 14 9 10 4 12 15

      }
//-----------------------------
    //Örnek 3: Bir List<Integer> içindeki tüm çift sayıları bulun ve bu sayıları aynı satırda,
    // aralarında bir boşluk olacak şekilde konsola yazdıran bir metod yazınız.(Structured)yani eski usul yap

    //Example 3:Find all even numbers in a List<Integer> and write a method that prints these numbers to the console on the same line, with a space between them.(Structured)
    ...
    public static void printEvenElements2(List<Integer> nums) {
                ...
                nums.
                stream().
                filter(t-> t%2 == 0).      //burda kontrol yapiyoruz
