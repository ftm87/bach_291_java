...
public class Lambda02 {
    ...
    //example 1: Create a method that takes a list of integers and prints the squares of the odd numbers in the list on the same line with a space between them.(Functional)
