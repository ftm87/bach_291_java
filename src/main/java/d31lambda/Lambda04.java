...
//example 2: Write a method that prints all unique (non-repetitive) elements with less than 5 characters in a List<String> to the console.
  ...
  //------------------------------
    ...
    //Örnek 3:Bir List<String> içinde karakter sayısı 5'ten fazla
    // olan tüm elemanları büyük harfe çevirip, bu elemanları yeni bir liste olarak döndüren bir metod yazınız.
