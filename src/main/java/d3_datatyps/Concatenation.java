...
public class Concatenation {
    public  static  void  main (String[]args){
       ...
       //Ornek 1: Bir String ve iki int variable olusturun. String degeri ile Integer’larin topla console’a yazdirin.
        //Example 1: Create a String and two int variables. Print the string value and the sum of the Integers to the

        //Not : concanation birlestirme islemi yapar'
