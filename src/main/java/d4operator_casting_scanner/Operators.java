...
public class Operators {
    ...
    public static void main(String[] args) {
       ...
       /*
        ...
        System.out.println(amountOfMoney1 / numberOfPeople1);// burasi normalde 2,5 cikmaliydi fakat java virgulden sonrasini sildi 2

       double amountOfMoney2 = 25; //8 byte ondalikli sayi
       int numberOfPeople2 = 10; //4 byte tamsayi
        //Buyuklukten kasit, daha fazla bilgi depolayabilmesidir.yani burda double daha buyuk
   ...
   Not: Karsilastirma operatorlerini kullandiginizda sonuc kesinlikle boolean (true, false) alirsiniz*/
       ...
       boolean c= 2 + 3 * 5 >=19 ;// false ( once carpma yapilir)
