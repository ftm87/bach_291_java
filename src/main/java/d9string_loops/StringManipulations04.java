    ...
    public static void main(String[] args) {
      ...
      /*Java’da Bellek Kullanımı:
        ...
        */
        ...
        System.out.println(str1 == str2); //false, adrese bakti
        System.out.println(str1.equals(str2)); //true, icerige bakti
        System.out.println(str1 == str3); //true, ayni adreste oturan kardesler
